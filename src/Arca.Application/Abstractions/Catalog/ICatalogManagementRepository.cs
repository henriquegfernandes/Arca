...
public interface ICatalogManagementRepository
{
    ...
    Task<bool> CategoryIsDescendantAsync(Guid tenantId, Guid categoryId, Guid possibleDescendantId, CancellationToken cancellationToken = default);
    ...
    Task<bool> ActivateCategoryAsync(Guid tenantId, Guid categoryId, CancellationToken cancellationToken = default);
    Task<bool> DeleteCategoryAsync(Guid tenantId, Guid categoryId, Guid? requestedByUserId, CancellationToken cancellationToken = default);
    ...
    Task<bool> ActivateProductTypeAsync(Guid tenantId, Guid productTypeId, CancellationToken cancellationToken = default);
    Task<bool> DeleteProductTypeAsync(Guid tenantId, Guid productTypeId, Guid? requestedByUserId, CancellationToken cancellationToken = default);
    Task<IReadOnlyCollection<AttributeDto>> ListProductTypeAttributesAsync(Guid tenantId, Guid productTypeId, CancellationToken cancellationToken = default);
    ...
    Task<bool> ActivateAttributeAsync(Guid tenantId, Guid attributeId, CancellationToken cancellationToken = default);
    Task<bool> DeleteAttributeAsync(Guid tenantId, Guid attributeId, Guid? requestedByUserId, CancellationToken cancellationToken = default);
    ...
    Task<bool> ActivateAttributeValueAsync(Guid tenantId, Guid attributeId, Guid valueId, CancellationToken cancellationToken = default);
    Task<bool> DeleteAttributeValueAsync(Guid tenantId, Guid attributeId, Guid valueId, Guid? requestedByUserId, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyCollection<ProductVariantDto>> UpdateProductVariantsAsync(UpdateProductVariantsData data, CancellationToken cancellationToken = default);
    Task<bool> DisableProductAsync(Guid tenantId, Guid productId, CancellationToken cancellationToken = default);
    Task<bool> ActivateProductAsync(Guid tenantId, Guid productId, CancellationToken cancellationToken = default);
    Task<bool> DeleteProductAsync(Guid tenantId, Guid productId, Guid? requestedByUserId, CancellationToken cancellationToken = default);
    ...
    Task<bool> DeleteProductVariantAsync(Guid tenantId, Guid productId, Guid variantId, Guid? requestedByUserId, CancellationToken cancellationToken = default);
}
