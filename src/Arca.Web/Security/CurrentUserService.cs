...
public sealed class CurrentUserService(
    ...
    ICurrentStoreService currentStore) : ICurrentUserService
{
    ...
    public Guid? CurrentTenantId => currentTenant.TenantId ?? TryGetGuid("arca:tenant_id");
    public Guid? CurrentStoreId => currentStore.StoreId ?? TryGetGuid("arca:store_id");
