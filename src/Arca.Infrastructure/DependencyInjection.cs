...
using Arca.Infrastructure.AuditLog;
using Arca.Infrastructure.Auth;
using Arca.Infrastructure.Email;
using Arca.Infrastructure.Catalog;
using Arca.Infrastructure.Dashboard;
...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services)
    {
        ...
        services.AddScoped<IPasswordSetupRepository, DapperPasswordSetupRepository>();
        ...
        services.AddScoped<IUserContextRepository, DapperUserContextRepository>();
